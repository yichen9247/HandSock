...
@Service
open class ServerUploadService @Autowired constructor(private val uploadDao: UploadDao) {
    @Transactional
    open fun getUploadList(page: Int, limit: Int): Map<String, Any> {
    ...
    @Transactional
    open fun deleteUpload(fid: String): Map<String, Any> {
