...
public class RobotSender {
    ...
    public void handleSendMessageOnBot(SocketIOServer server, SocketIOClient client, Object dataEvent, AckRequest ackRequest) {
        ...
        try {
            ...
            if (isCommandMessage(data, robotsEvent, authToken)) {
    ...
    private boolean isCommandMessage(Map<String, Object> data, RobotsEvent robotsEvent, Map<String, Object> authToken) {
        return Objects.equals(clientService.getClientData(data, TYPE_KEY), "text") && robotsEvent.commandList.contains(clientService.getClientData(data, CONTENT_KEY));
    }
